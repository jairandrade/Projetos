...
Private cFilBrwK		:= "(C5_XPVSPC  == 'S') .And. (C5_XSTSSPP == '2')" //Recebido pela supplier
Private  cCRLF		:= CRLF

//Validar os ultimos 12meses(360)
If cEmpAnt <> '04' 
	MsgInfo("Esta rotina funciona apenas para informações da empresa 04 (Industria)","KAPAZI - Pedidos Supplier SUPPLIER CARD")
	Return
EndIf
...
oMark:SetFieldMark('C5_FLAGSP3') //Trocar para C5_FLAGSP3
...
oMark:SetMark(oMark:Mark(),cAlias,"C5_FLAGSP3")
...
Add Option aMenu Title 'Visualizar' 		Action 'ViewDef.KP97B05' 				Operation 2 Access 0  //
Add Option aMenu Title 'Integrar'  			Action 'U_KP97A09' 						Operation 4 Access 0
...
oModel := MPFormModel():New("KP97B05C",/*Pre-Validacao*/,,/*Commit*/,/*Cancel*/)
...
oModel	:=	FwLoadModel('KP97B05')	//Retorna o Objeto do Modelo de Dados- nome do fonte de onde queremos obter o modelo de dados
