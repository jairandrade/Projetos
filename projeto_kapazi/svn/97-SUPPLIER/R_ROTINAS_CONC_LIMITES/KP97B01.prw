...
#Include "topconn.ch"
//==================================================================================================//
//	Programa: KP97B01		|	Autor: Luis Paulo							|	Data: 11/07/2018	//
//==================================================================================================//
//	Descrição: FWMarkBrowse onde será marcado os título que vão para supplier						//
//	Concessao de limites																			//
//==================================================================================================//
User Function KP97B01()
Local	cAlias		:= "SE1"
Local 	oMark
...
Private cFilBrwK		:= "DTOS(E1_EMISSAO) >= '"+DTOS(cData)+"' .And. ( ( E1_PREFIXO = '1  ' .And. E1_TIPO == 'NF '  .And. Empty(E1_XIDVNFK)) .OR. (E1_TIPO == 'FT ' .And. !Empty(E1_XIDVNFK)) )  " //NOTAS BAIXADASC
Private  cCRLF		:= CRLF
...
oMark:SetFieldMark('E1_FLAGSPC')
oMark:SetDescription('CR - Concessão de Limites Supplier')
oMark:SetAfterMark(bAfterMark)
oMark:SetAllMark(bMarkAll)
oMark:SetAmbiente(.F.)
oMark:SetWalkThru(.F.)
oMark:DisableDetails()
oMark:SetMark(oMark:Mark(),cAlias,"E1_FLAGSPC")
...
Add Option aMenu Title 'Visualizar' 		Action 'ViewDef.KP97B01' 				Operation 2 Access 0  //
//Add Option aMenu Title 'Processar'  		Action 'StaticCall(KP97B01,FWMARK1P)' 	Operation 2 Access 0
Add Option aMenu Title 'Integrar'  			Action 'U_KP97A00' 						Operation 4 Access 0
Add Option aMenu Title 'Cliente sem Mov'  	Action 'U_KP97A01' 						Operation 2 Access 0
//Add Option aMenu Title 'Enviar p/ Supplier'	Action 'U_KP97PE00' 					Operation 2 Access 0
...
oModel := MPFormModel():New("KP97B01C",/*Pre-Validacao*/,,/*Commit*/,/*Cancel*/)
...
oModel:SetDescription( 'Modelo de Dados Contas a Receber' )

//Adiciona Descricao do Componente do Modelo de Dados
cTexto := 'Formulario Contas a Receber'
...
oModel	:=	FwLoadModel('KP97B01')	//Retorna o Objeto do Modelo de Dados- nome do fonte de onde queremos obter o modelo de dados
...
If nRegs > 1
	lRet		:= .F.
	MsgAlert("Existe mais de um cliente selecionado, favor verificar!!!","KAPAZI - INTEGRACAO SUPPLIER")
EndIf
