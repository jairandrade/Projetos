...
#Include "topconn.ch"
//==================================================================================================//
//	Programa: KP97B09		|	Autor: Luis Paulo							|	Data: 02/09/2018	//
//==================================================================================================//
//	Descrição: FWMarkBrowse onde serao marcados os pv que foram alterados na supplier		 		//
//																									//
//																									//
//==================================================================================================//
User Function KP97B09()
Local	cAlias		:= "SC5"
Local 	oMark
...
Private cFilBrwK	:= "(C5_XPVSPC  == 'S') .And. Empty(C5_NOTA) .And. (C5_XSTSSPP == 'A')" //Recebido pela supplier
Private  cCRLF		:= CRLF

//Validar os ultimos 12meses(360)
If cEmpAnt <> '04' 
	MsgInfo("Esta rotina funciona apenas para informações da empresa 04 (Industria)","KAPAZI - Alteracao de Pedidos Supplier")
	Return
EndIf
...
oMark:SetFieldMark('C5_FLAGSP6') //Trocar para C5_FLAGSP6
oMark:SetDescription('Alteracao de Pedidos Supplier')
oMark:SetAfterMark(bAfterMark)
oMark:SetAllMark(bMarkAll)
oMark:SetAmbiente(.F.)
oMark:SetWalkThru(.F.)
oMark:DisableDetails()
oMark:SetMark(oMark:Mark(),cAlias,"C5_FLAGSP6")
...
Add Option aMenu Title 'Visualizar' 		Action 'ViewDef.KP97B09' 				Operation 2 Access 0  //
...
oModel := MPFormModel():New("KP97B09C",/*Pre-Validacao*/,,/*Commit*/,/*Cancel*/)
...
oModel	:=	FwLoadModel('KP97B09')	//Retorna o Objeto do Modelo de Dados- nome do fonte de onde queremos obter o modelo de dados
...
+-----------+------------+-------+--------------------+------+-------------+
! Descricao ! Limpa o campo C5_FLAGSP6.                                         !
+-----------+--------------------------------------------------------------+
*/
