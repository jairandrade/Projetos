...
#Include "topconn.ch"
//==================================================================================================//
//	Programa: KP97PE04		|	Autor: Luis Paulo							|	Data: 07/09ñ/2018	//
//==================================================================================================//
//	Descrição: Funcao responsavel por gerar o arquivo Supplier pre autorizacao						//
//																									//
//==================================================================================================//
User Function KP97PE04()
Private cNmArq	:= ""
Private nHdlLog	:= ""
Private cPData		:= GetSrvProfString ("ROOTPATH","")
Private cDirtAtu	:= "\Supplier\Pre Aut PV\"
Private lCriou		:= .F.
Private cArqAtu		:= ""
Private cArqNew		:= ""
Private cDir		:= ""
...
Private cDirProc	:= "\Supplier\Pre Aut PV\Enviados"
Private cIdSP		:= ""	
Private lErroE		:= .F.

If ValItenS() //Valida se tem itens pendentes de verificacao
		U_KP97A10() //Processa os registro pendentes da supplier
...
If lRet
		cSql	+= " SET ZS4_NMARQI = '"+cNmArq+"'"//, ZS4_ENVEMA = 'S' "
	Else
		cSql	+= " SET ZS4_NMARQI = '"+cNmArq+"'" //, ZS4_ENVEMA = 'N' "
EndIf
cSql	+= " WHERE ZS4_XIDINT = '"+cIdSP+"' "
