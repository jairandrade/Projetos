...
//==================================================================================================//
//	Descrição: Formulario Ren Pre autorizacao														//
//																									//
//==================================================================================================//
User function CADZS5()
Local cAlias	:= "ZS5"
Local cDesc		:= "Supplier Card - Ren Pré Aut Pedidos de Venda de pedidos"
Local lEnable	:= .T.
Private oBrowse := FwMBrowse():New() //usar a classe ao invez da função // Declaração da classe

If cEmpAnt <> '04' 
	MsgInfo("Esta rotina funciona apenas para informações da empresa 04 (Industria)","KAPAZI -  REN PRÉ-AUT PEDIDOS DE VENDA SUPPLIER CARD")
	Return
EndIf
...
ADD OPTION aRotina Title 'Visualizar' 			Action 'VIEWDEF.CADZS5' 	OPERATION 2 ACCESS 0 //ACCESS É O NÍVEL DE ACESSO DO USUARIO
