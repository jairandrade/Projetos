...
//==================================================================================================//
//	Descrição: Formulario concessao de limites														//
//																									//
//==================================================================================================//
User function CADZS1()
Local cAlias	:= "ZS1"
Local cDesc		:= "Integracao Supplier - Concessão de Limites"
Local lEnable	:= .T.
...
ADD OPTION aRotina Title 'Visualizar' 			Action 'VIEWDEF.CADZS1' 	OPERATION 2 ACCESS 0 //ACCESS É O NÍVEL DE ACESSO DO USUARIO
