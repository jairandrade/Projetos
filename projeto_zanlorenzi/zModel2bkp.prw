...
//Variáveis Estáticas
Static cTitulo := "Cadastro de EDI das transportadoras"
...
Static Function ModelDef()
    ...
    oStTmp:AddTable('ZA0', {'ZA0_FILIAL', 'ZA0_CODIGO', 'ZA0_DESCRI'}, "Cabecalho ZA0")
    ...
    oStTmp:AddField(;
        ...
        FwBuildFeature( STRUCT_FEATURE_INIPAD, "Iif(!INCLUI,ZA0->ZA0_CODIGO,'')" ),;    // [11]  B   Code-block de inicializacao do campo
        .T.,;                                                                         // [12]  L   Indica se trata-se de um campo chave
        .F.,;                                                                         // [13]  L   Indica se o campo pode receber valor em uma operação de update.
        .F.)                                                                          // [14]  L   Indica se o campo é virtual
    ...
    oStTmp:AddField(;
        ...
        {},;                                                                          // [09]  A   Lista de valores permitido do campo
        .T.,;                                                                         // [10]  L   Indica se o campo tem preenchimento obrigatório
        FwBuildFeature( STRUCT_FEATURE_INIPAD, "Iif(!INCLUI,ZA0->ZA0_DESCRI,'')" ),;   // [11]  B   Code-block de inicializacao do campo
    ...
    oModel:GetModel('ZA0DETAIL'):SetUniqueLine({"ZA0_CODIGO"})
	...
	If nOpc == MODEL_OPERATION_INSERT
		...
		For nAtual := 1 To Len(aColsAux)
			...
			If ! aColsAux[nAtual][Len(aHeadAux)+1]
				...
				ZA0_CODIGO   := cCodigo
				ZA0_DESCRI   := cDescri
				ZA0_OCOR      := aColsAux[nAtual][nPosOcor]
