...
Static Function MenuDef()
    ...
    ADD OPTION aRot Title 'Copiar'     ACTION 'u_OMS101C' OPERATION 9 ACCESS 0 //OPERATION 9
        ADD OPTION aRot TITLE 'mvcgrid'    ACTION 'u_MCFG0006I' OPERATION 6 ACCESS 0 //OPERATION 5
...
User Function OMS101S()
	...
	Local nPosCodReg := aScan(aHeadAux, {|x| AllTrim(Upper(x[2])) == AllTrim("ZA0_CODREG")})
	Local nAtual     := 0
	...
	If nOpc == 3
		...
		For nAtual := 1 To oModelGrid:Length()
			...
			If(!oModelGrid:IsDeleted())
                ...
                ZA0_CODREG    := oModelGrid:aCols[nAtual][nPosCodReg]
