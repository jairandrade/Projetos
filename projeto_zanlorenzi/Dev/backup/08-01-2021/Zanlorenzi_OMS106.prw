...
Static Function GeraNF(_aNotas)
	...
	For i := 1 to Len(_aNotas)
		...
		If lContinua
			...
			cQuery := " SELECT C5_CONDPAG, ZA7_PEDIDO, ZA7_ITEMPD  "
				...
				Begin Transaction
					...
					Else
						...
						If ZA6->(dbSeek(xFilial("ZA6")+cCodZA7))
							RecLock("ZA6",.F.)
							ZA6_MSG := ZA6_MSG+"Nf. "+cNFSaida+" foi gerada com sucesso."+CHR(13)+CHR(10)
							ZA6->(MsUnlock())
						EndIf
						//Gera Romaneio
						cMsgErro := U_GeraRoma()
