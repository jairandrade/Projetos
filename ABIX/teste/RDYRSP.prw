...
#define STR0003 "Deseja transferir os registros de campo MEMO dos módulos Recrutamento & Seleção e Terminal de Consulta (SIGARSP/SIGATCF) gravados na tabela SYP para a tabela RDY?"
...
dbSetOrder(1)
    ...
    While ( cAliasSYP )->( !Eof() )  
        ...
        If SX3->(dbSeek((cAliasSYP)->YP_CAMPO))
	        ...
	        If ! RDY->(dbSeek(cTmpFilTab + cTmpChave)) //NÃ£o grava se jÃ¡ tiver RDY_FILIAL gravado
		        ...
		        Else
                    ...
                    // Se jÃ¡ existe o registro atualiza apenas o campo RDY_FILTAB
