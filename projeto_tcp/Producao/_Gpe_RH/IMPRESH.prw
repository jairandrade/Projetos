...
±±|Coutinho    |          |           |no relatÛrio                                |±±
±±|Jaqueline   |18/01/2018|DRHPAG-    |Retirada a correÁ„o efetuada nas margens e  |±±
±±|Laurenti    |          |11618      |alinhamento do relatÛrio                    |±±
...
If lHomolog
	...
	nL += 70
	oPrint:say (nL+nPT,140		,STR0146, oFont08)  //ìFICA RESSALVADO O DIREITO DE O TRABALHADOR PLEITEAR JUDICIALMENTE OS DIREITOS INFORMADOS NO CAMPO 155, ABAIXO."
Else
	nL += 35
