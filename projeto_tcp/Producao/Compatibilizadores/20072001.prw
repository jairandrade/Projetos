...
/*/
//-------------------------------------------------------------------
User Function 20072001()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '20072001 - Atualização de dicionários e Tabelas'
...
Private cDevName   := 'VIEEIRA           '
Private cTicket    := '200720'
Private lAuditDic  := .F.
Private aAudiVal   := {,}
Private cAudiReg   := '' 
Private cTimeIni   := '' 
...
no banco de dados do AUDIT_TRAIL.@author VIEEIRA           
@since 20/07/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
suficientes para criar um novo registro no dicionario.@author VIEEIRA           
@since 20/07/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
DO DICIONARIO PARA O BANCO ORACLE (AUDITORIA).@author VIEEIRA           
@since 20/07/20
@version 1.0 
/*/
//-------------------------------------------------------------------
