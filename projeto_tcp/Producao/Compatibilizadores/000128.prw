...
/*/
//-------------------------------------------------------------------
User Function 000128()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '000128 - Atualização de dicionários e Tabelas'
...
Local cDesc5       := '[DIVERSOS] :SX3,SIX,SX6'
...
aEstrut := {'INDICE','ORDEM','CHAVE','DESCRICAO','DESCSPA','DESCENG','PROPRI','F3','NICKNAME','SHOWPESQ','IX_VIRTUAL','IX_VIRCUST'}
 ...
 aAdd( aSIX, {                            ; 
        'TN3', ; //INDICE
        '3', ; //ORDEM
        'TN3_FILIAL+TN3_XDOC+TN3_XSERIE+TN3_FORNEC+TN3_LOJA+TN3_CODEPI                                                                                                   ', ; //CHAVE
        'Documento+Serie+Fornecedor+Loja+Código                                ', ; //DESCRICAO
        'Documento+Serie+Proveedor+Tienda+Codigo                               ', ; //DESCSPA
        'Documento+Serie+Proveedor+Tienda+Codigo                               ', ; //DESCENG
        'U', ; //PROPRI
        '                                                                                                                                                                ', ; //F3
        '          ', ; //NICKNAME
        'N', ; //SHOWPESQ
...
EndIf
aAdd( aSX6Temp , 'TCP_INTMST' )  //X6_VAR
aAdd( aSX6Temp , 'L' )  //X6_TIPO
aAdd( aSX6Temp , 'Este parametro tem como objetivo habilitar a integ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , 'racao entre o documento de entrada e medicina e se' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG1
aAdd( aSX6Temp , 'guranca do trabalho.                              ' )  //X6_DESC2
...
Else
   aAdd( aSX6Temp , '  ' )  //X6_FIL
EndIf
aAdd( aSX6Temp , 'TCP_COMMDT' )  //X6_VAR
aAdd( aSX6Temp , 'C' )  //X6_TIPO
aAdd( aSX6Temp , 'Define o momento da chamada da tela EPI x MDT.    ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , '1=Pre nota de entrada. 2=Documento de entrada.    ' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG1
aAdd( aSX6Temp , '                                                  ' )  //X6_DESC2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG2
aAdd( aSX6Temp , '2                                                                                                                                                                                                                                                       ' )  //X6_CONTEUD
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTSPA
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTENG
aAdd( aSX6Temp , 'U' )  //X6_PROPRI
aAdd( aSX6Temp , ' ' )  //X6_PYME
