...
/*/
//-------------------------------------------------------------------
User Function 2019396()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '2019396 - Atualização de dicionários e Tabelas'
...
aAdd( aSX3, { ;
   ...
   'Data Lib.   ' , ; //X3_TITSPA
   'Data Lib.   ' , ; //X3_TITENG
   'Data de Liberacao        ' , ; //X3_DESCRIC
   'Data de Liberacao        ' , ; //X3_DESCSPA
   'Data de Liberacao        ' , ; //X3_DESCENG
   '                                             ' , ; //X3_PICTURE
   '                                                                                                                                ' , ; //X3_VALID
   ...
   'CTOD(' + SIMPLES + '//' + SIMPLES + ')                                                                                                                      ' , ; //X3_RELACAO
   '      ' , ; //X3_F3
    0 , ; //X3_NIVEL
   'þÀ' , ; //X3_RESERV
   ' ' , ; //X3_CHECK
...
aAdd( aSX3, { ;
   ...
   'R' , ; //X3_CONTEXT
    Chr(000) , ; //X3_OBRIGAT
   '                                                                                                                                ' , ; //X3_VLDUSER
   '02=Aguardando Liberacao;03=Liberado;06=Rejeitado                                                                                ' , ; //X3_CBOX
   '                                                                                                                                ' , ; //X3_CBOXSPA
   '                                                                                                                                ' , ; //X3_CBOXENG
   '                    ' , ; //X3_PICTVAR
   '                                                            ' , ; //X3_WHEN
...
aAdd( aSX3, { ;
   ...
   'Usu.Lib.    ' , ; //X3_TITSPA
   'Usu.Lib.    ' , ; //X3_TITENG
   'Usuario de liberacao     ' , ; //X3_DESCRIC
   'Usuario de liberacao     ' , ; //X3_DESCSPA
   'Usuario de liberacao     ' , ; //X3_DESCENG
   '@!                                           ' , ; //X3_PICTURE
   '                                                                                                                                ' , ; //X3_VALID
    Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160) , ; //X3_USADO
   '                                                                                                                                ' , ; //X3_RELACAO
