...
Local aMarcadas    := {}
Local lExclu       := .F.
Local cTitulo      := '202024 - Atualização de dicionários e Tabelas'
...
aAdd( aSX1, { ;
   'APD20U    ' , ; //X1_GRUPO
   '04' , ; //X1_ORDEM
   'Código Até                    ' , ; //X1_PERGUNT
   'Código Até                    ' , ; //X1_PERSPA
   'Código Até                    ' , ; //X1_PERENG
   'MV_CH3' , ; //X1_VARIAVL
   'C' , ; //X1_TIPO
    6 , ; //X1_TAMANHO
    0 , ; //X1_DECIMAL
...
aAdd( aSX1, { ;
   'APD20U    ' , ; //X1_GRUPO
   '06' , ; //X1_ORDEM
   'Função Até                    ' , ; //X1_PERGUNT
   'Função Até                    ' , ; //X1_PERSPA
   'Função Até                    ' , ; //X1_PERENG
   'MV_CH5' , ; //X1_VARIAVL
   'C' , ; //X1_TIPO
    5 , ; //X1_TAMANHO
    0 , ; //X1_DECIMAL
...
aAdd( aSX1, { ;
   'APD20U    ' , ; //X1_GRUPO
   '07' , ; //X1_ORDEM
   'Usuário Portal                ' , ; //X1_PERGUNT
   'Usuário Portal                ' , ; //X1_PERSPA
   'Usuário Portal                ' , ; //X1_PERENG
   'MV_CH6' , ; //X1_VARIAVL
   'C' , ; //X1_TIPO
    6 , ; //X1_TAMANHO
    0 , ; //X1_DECIMAL
...
aAdd( aSX1, { ;
   'APD20U    ' , ; //X1_GRUPO
   '08' , ; //X1_ORDEM
   'Alterar já preenchidos?       ' , ; //X1_PERGUNT
   'Alterar já preenchidos?       ' , ; //X1_PERSPA
   'Alterar já preenchidos?       ' , ; //X1_PERENG
   'MV_CH7' , ; //X1_VARIAVL
   'N' , ; //X1_TIPO
    1 , ; //X1_TAMANHO
    0 , ; //X1_DECIMAL
