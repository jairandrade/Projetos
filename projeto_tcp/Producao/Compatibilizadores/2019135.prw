...
/*/
//-------------------------------------------------------------------
User Function 2019135()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '2019135 - Atualização de dicionários e Tabelas'
...
aAdd( aSX3, { ;
   ...
   'R' , ; //X3_CONTEXT
    Chr(000) , ; //X3_OBRIGAT
   '                                                                                                                                ' , ; //X3_VLDUSER
   'PC=Pedido de Compras;FI=Financeiro;CT=Contratos                                                                                 ' , ; //X3_CBOX
   '                                                                                                                                ' , ; //X3_CBOXSPA
   '                                                                                                                                ' , ; //X3_CBOXENG
   '                    ' , ; //X3_PICTVAR
   '                                                            ' , ; //X3_WHEN
