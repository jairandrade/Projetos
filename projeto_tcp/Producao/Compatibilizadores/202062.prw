...
/*/
//-------------------------------------------------------------------
User Function 202062()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .F.
Local cTitulo      := '202062 - Atualização de dicionários e Tabelas'
...
aAdd( aSX6Temp , 'Habilita alteracao de todos os campos no contas a ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , 'pagar de titulos oriundos do fluxo de pagamentos m' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG1
aAdd( aSX6Temp , 'anuais.                                           ' )  //X6_DESC2
