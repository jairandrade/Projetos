...
/*/
//-------------------------------------------------------------------
User Function 2019494()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '2019494 - Atualização de dicionários e Tabelas'
...
aAdd( aSX3, { ;
   ...
   'C' , ; //X3_TIPO
    1 , ; //X3_TAMANHO
    0 , ; //X3_DECIMAL
   'Tipo Deslig.' , ; //X3_TITULO
   'Tipo Deslig.' , ; //X3_TITSPA
   'Tipo Deslig.' , ; //X3_TITENG
   'Tipo de desligamento     ' , ; //X3_DESCRIC
   'Tipo de desligamento     ' , ; //X3_DESCSPA
   'Tipo de desligamento     ' , ; //X3_DESCENG
   '@!                                           ' , ; //X3_PICTURE
   '                                                                                                                                ' , ; //X3_VALID
   ...
   'R' , ; //X3_CONTEXT
    Chr(128) , ; //X3_OBRIGAT
   '                                                                                                                                ' , ; //X3_VLDUSER
   'V=Voluntario;F=Forcado;O=Obito/Furto                                                                                            ' , ; //X3_CBOX
   '                                                                                                                                ' , ; //X3_CBOXSPA
   '                                                                                                                                ' , ; //X3_CBOXENG
   '                    ' , ; //X3_PICTVAR
   '                                                            ' , ; //X3_WHEN
