...
/*/
//-------------------------------------------------------------------
User Function 2019472()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '2019472 - Atualização de dicionários e Tabelas'
...
aEstrut := {'INDICE','ORDEM','CHAVE','DESCRICAO','DESCSPA','DESCENG','PROPRI','F3','NICKNAME','SHOWPESQ','IX_VIRTUAL','IX_VIRCUST'}
 ...
 aAdd( aSIX, {                            ; 
        'TNY', ; //INDICE
        '9', ; //ORDEM
        'TNY_FILIAL+TNY_GRPCID+TNY_NUMFIC                                                                                                                                ', ; //CHAVE
        'Grupo C.I.D.+Ficha Medica                                             ', ; //DESCRICAO
        'Grupo C.I.D.+Ficha Medica                                             ', ; //DESCSPA
        'ICD Group+Ficha Medica                                                ', ; //DESCENG
        'U', ; //PROPRI
        '                                                                                                                                                                ', ; //F3
        '          ', ; //NICKNAME
        'S', ; //SHOWPESQ
...
EndIf
aAdd( aSX6Temp , 'TCP_MAIAFP' )  //X6_VAR
aAdd( aSX6Temp , 'C' )  //X6_TIPO
aAdd( aSX6Temp , 'Emails que serao notificados atestados medicos lan' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , 'cados fora do prazo.                              ' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG1
aAdd( aSX6Temp , '                                                  ' )  //X6_DESC2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG2
aAdd( aSX6Temp , 'ext_kaique.souza@tcp.com.br;ext_suellen.sora@tcp.com.br                                                                                                                                                                                                   ' )  //X6_CONTEUD
