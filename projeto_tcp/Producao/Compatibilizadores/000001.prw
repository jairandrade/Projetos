...
/*/
//-------------------------------------------------------------------
User Function 000001()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '000001 - Atualização de dicionários e Tabelas'
...
Private cDevName   := 'Eduardo Vieira    '
Private cTicket    := '000001'
Private lAuditDic  := .F.
Private aAudiVal   := {,}
Private cAudiReg   := '' 
Private cTimeIni   := '' 
...
no banco de dados do AUDIT_TRAIL.@author Eduardo Vieira    
@since 21/01/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
suficientes para criar um novo registro no dicionario.@author Eduardo Vieira    
@since 21/01/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
DO DICIONARIO PARA O BANCO ORACLE (AUDITORIA).@author Eduardo Vieira    
@since 21/01/20
@version 1.0 
/*/
//-------------------------------------------------------------------
