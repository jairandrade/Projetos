...
/*/
//-------------------------------------------------------------------
User Function 0001282()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .F.
Local cTitulo      := '0001282 - Atualização de dicionários e Tabelas'
...
aAdd( aSX3, { ;
   ...
   'Nil' , ; //X3_CBOXENG
   'Nil' , ; //X3_PICTVAR
   'Empty(aCols[n][GDFIELDPOS(' + DUPLAS + 'TNF_YNUMRE' + DUPLAS + ')])                   ' , ; //X3_WHEN
   'Nil' , ; //X3_INIBRW
   'Nil' , ; //X3_GRPSXG
   'Nil' , ; //X3_FOLDER
   'Nil' , ; //X3_PYME
...
aAdd( aSXB, { ; 
   ...
   '03' , ; //XB_SEQ
   '04' , ; //XB_COLUNA
   'Grupo + Codigo      ' , ; //XB_DESCRI
   'Grupo + Codigo      ' , ; //XB_DESCSPA
   'Inven.group + Produc' , ; //XB_DESCENG
   '                                                                                                                                                                                                                                                          ' , ; //XB_CONTEM
   '                                                                                                                                                                                                                                                          ' } ) //XB_WCONTEM
...
aAdd( aSXB, { ; 
   ...
   '                    ' , ; //XB_DESCSPA
   '                    ' , ; //XB_DESCENG
   '@B1_TIPO IN (' + DUPLAS + 'ES' + DUPLAS + ',' + DUPLAS + 'FS' + DUPLAS + ')                                                                                                                                                                                                                                   ' , ; //XB_CONTEM
   '                                                                                                                                                                                                                                                          ' } ) //XB_WCONTEM
