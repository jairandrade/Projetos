...
/*/
//--------------------------------------------------------------------
User Function UPDTCSE1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTCSE1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTCSE1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	16																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Custas Cobr.'															, ; //X3_TITULO
	'Custas Cobr.'															, ; //X3_TITSPA
	'Custas Cobr.'															, ; //X3_TITENG
	'Valor Custas Cobrança'													, ; //X3_DESCRIC
	'Valor Custas Cobrança'													, ; //X3_DESCSPA
	'Valor Custas Cobrança'													, ; //X3_DESCENG
...
aAdd( aSX7, { ;
	'E1_XCUSTCO'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'(M->E1_XCUSTCO+M->E1_XMULTA+M->E1_XJUROS)'								, ; //X7_REGRA
	'E1_ACRESC'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Informe o valor do juros' )
aHlpEng := {}
aHlpSpa := {}

PutSX1Help( "PE1_XJUROS ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "E1_XJUROS" )

aHlpPor := {}
aAdd( aHlpPor, 'Informe o valor da multa' )
aHlpEng := {}
aHlpSpa := {}

PutSX1Help( "PE1_XMULTA ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "E1_XMULTA" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTCSE1" ) ) ) ;
