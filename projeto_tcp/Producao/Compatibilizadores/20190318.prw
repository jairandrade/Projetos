...
/*/
//-------------------------------------------------------------------
User Function 20190318()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '20190318 - Atualização de dicionários e Tabelas'
...
aAdd( aSX3, { ;
   ...
   'Contrato    ' , ; //X3_TITSPA
   'Contrato    ' , ; //X3_TITENG
   'Num Contrato             ' , ; //X3_DESCRIC
   'Num Contrato             ' , ; //X3_DESCSPA
   'Num Contrato             ' , ; //X3_DESCENG
   '@!                                           ' , ; //X3_PICTURE
   '                                                                                                                                ' , ; //X3_VALID
   ...
   'R' , ; //X3_CONTEXT
    Chr(032) , ; //X3_OBRIGAT
   'ExistCpo(' + DUPLAS + 'CN9' + DUPLAS + ',M->E2_XCONTRA,,,,.F.)                                                                                            ' , ; //X3_VLDUSER
   '                                                                                                                                ' , ; //X3_CBOX
   '                                                                                                                                ' , ; //X3_CBOXSPA
   '                                                                                                                                ' , ; //X3_CBOXENG
   '                    ' , ; //X3_PICTVAR
