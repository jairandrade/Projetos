...
/*/
//--------------------------------------------------------------------
User Function UPDTCZAC( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTCZAC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTCZAC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 254																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'URL integrac'														, .T. }, ; //X3_TITULO
	{ 'URL integrac'														, .T. }, ; //X3_TITSPA
	{ 'URL integrac'														, .T. }, ; //X3_TITENG
	{ 'URL integração'														, .T. }, ; //X3_DESCRIC
	{ 'URL integração'														, .T. }, ; //X3_DESCSPA
	{ 'URL integração'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZAC'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZAC_RETINT'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Retorno Inte'														, .T. }, ; //X3_TITULO
	{ 'Retorno Inte'														, .T. }, ; //X3_TITSPA
	{ 'Retorno Inte'														, .T. }, ; //X3_TITENG
	{ 'Retorno Integração'													, .T. }, ; //X3_DESCRIC
	{ 'Retorno Integração'													, .T. }, ; //X3_DESCSPA
	{ 'Retorno Integração'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZAC'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZAC_HEADRT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Head Retorno'														, .T. }, ; //X3_TITULO
	{ 'Head Retorno'														, .T. }, ; //X3_TITSPA
	{ 'Head Retorno'														, .T. }, ; //X3_TITENG
	{ 'Head Retorno  HTTP'													, .T. }, ; //X3_DESCRIC
	{ 'Head Retorno  HTTP'													, .T. }, ; //X3_DESCSPA
	{ 'Head Retorno  HTTP'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTCZAC" ) ) ) ;
