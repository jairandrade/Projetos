...
/*/
//-------------------------------------------------------------------
User Function 20200601()

Local aSay         := {}
Local aButton      := {}
Local aMarcadas    := {}
Local lExclu       := .T.
Local cTitulo      := '20200601 - Atualização de dicionários e Tabelas'
...
If ( lOpen := MyOpenSm0Ex(lExclu) )
   ...
   If lOpen
      ...
      For nI := 1 To Len( aRecnoSM0 )
         ...
         //ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
         oProcess:IncRegua1( 'Dicionário SX6 ' + Left( aRecnoSM0[nI][1] + ' ' + aRecnoSM0[nI][3] , 20 ) )
...
no banco de dados do AUDIT_TRAIL.@author Vieira            
@since 01/06/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
suficientes para criar um novo registro no dicionario.@author Vieira            
@since 01/06/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
DO DICIONARIO PARA O BANCO ORACLE (AUDITORIA).@author Vieira            
@since 01/06/20
@version 1.0 
/*/
//-------------------------------------------------------------------
...
aAdd( aSX3, { ;
   ...
   'Grp Sales   ' , ; //X3_TITSPA
   'Grp Sales   ' , ; //X3_TITENG
   'Grp Aprovacao Sales      ' , ; //X3_DESCRIC
   'Grp Aprovacao Sales      ' , ; //X3_DESCSPA
   'Grp Aprovacao Sales      ' , ; //X3_DESCENG
   '@!                                           ' , ; //X3_PICTURE
   '                                                                                                                                ' , ; //X3_VALID
    Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160) , ; //X3_USADO
   '                                                                                                                                ' , ; //X3_RELACAO
...
aAdd( aSX3, { ;
   ...
   'R' , ; //X3_CONTEXT
    Chr(032) , ; //X3_OBRIGAT
   '                                                                                                                                ' , ; //X3_VLDUSER
   '1=Envia Pedido;2=Consulta Alçada;4=Aprovação' , ; //X3_CBOX
   '                                                                                                                                ' , ; //X3_CBOXSPA
   '                                                                                                                                ' , ; //X3_CBOXENG
   '                    ' , ; //X3_PICTVAR
   '                                                            ' , ; //X3_WHEN
...
EndIf
aAdd( aSX6Temp , 'TCP_PCSFOR' )  //X6_VAR
aAdd( aSX6Temp , 'L' )  //X6_TIPO
aAdd( aSX6Temp , 'Integra PC com Sales                              ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , '                                                  ' )  //X6_DESC1
...
Else
   aAdd( aSX6Temp , '  ' )  //X6_FIL
EndIf
aAdd( aSX6Temp , 'TCP_URLALC' )  //X6_VAR
aAdd( aSX6Temp , 'C' )  //X6_TIPO
aAdd( aSX6Temp , 'Url alçada Sales                                  ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , '                                                  ' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
...
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG2
aAdd( aSX6Temp , 'ObterAreaPurchaseOrder                                                                                                                                                                                                                                    ' )  //X6_CONTEUD
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTSPA
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTENG
aAdd( aSX6Temp , ' ' )  //X6_PROPRI
aAdd( aSX6Temp , ' ' )  //X6_PYME
aAdd( aSX6Temp , '                                                                                                                                ' )  //X6_VALID
aAdd( aSX6Temp , '                                                                                                                                ' )  //X6_INIT
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_DEFPOR
...
Else
   aAdd( aSX6Temp , '  ' )  //X6_FIL
EndIf
aAdd( aSX6Temp , 'TCP_URLPCS' )  //X6_VAR
aAdd( aSX6Temp , 'C' )  //X6_TIPO
aAdd( aSX6Temp , 'URL Envio Pedido Sales                            ' )  //X6_DESCRIC
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG
aAdd( aSX6Temp , '                                                  ' )  //X6_DESC1
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA1
...
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCSPA2
aAdd( aSX6Temp , '                                                  ' )  //X6_DSCENG2
aAdd( aSX6Temp , 'https://wsc-hom.tcp.com.br/SalesForce/api/                                                                                                                                                                                                                ' )  //X6_CONTEUD
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTSPA
aAdd( aSX6Temp , '                                                                                                                                                                                                                                                          ' )  //X6_CONTENG
aAdd( aSX6Temp , 'U' )  //X6_PROPRI
aAdd( aSX6Temp , ' ' )  //X6_PYME
