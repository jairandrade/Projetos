...
Static Function ModelDef()
    ...
    oStruZA0:SetProperty( 'ZA0_CODBAR'   , MODEL_FIELD_VALID 	,  { |oFld| xCODBAR2(oFld:GetValue('ZA0_CODBAR'),oFld) } )
...
Static Function xCODBAR2(_cCodBar,oFld)
local cret:=""
