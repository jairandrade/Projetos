...
//TODO Declaração do WebService GetTeknisa2
@author Paulo Gabriel F.Silva
@since 09/08/2018
@version 1.0
/*/

WSRESTFUL GetTeknisa2 DESCRIPTION "Madero - Consultar as informações do grupo Teknisa Nivel 2 - FLUIG"

	WSMETHOD POST DESCRIPTION "Consultar as informações do grupo Teknisa Nivel 2 para integração FLUIG" WSSYNTAX "/GetTeknisa2"

END WSRESTFUL


/*/{Protheus.doc} POST
//TODO Declaração do Metodo GetTeknisa2
@author Paulo Gabriel F.Silva
@since 09/08/2018
@version 1.0
/*/
...
//TODO Metodo para gerar JSON com Listas do Teknisa de Nível 2.
@author Paulo Gabriel F.Silva
@since 09/08/2018
@version 1.0
...
//TODO Função para executar WS GetTeknisa2
