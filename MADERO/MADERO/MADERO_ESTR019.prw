...
!Nome              ! ESTR019                                                 !
+------------------+---------------------------------------------------------+
!Descrição         ! Relatório Inventário SD3 - GESTOR             			 !
+------------------+---------------------------------------------------------+
!Autor             ! Jair Matos                                  		     !
+------------------+---------------------------------------------------------+
...
User function ESTR019()
	Local cTitle 	:= OemToAnsi("Relatório Inventário SD3 - GESTOR")
	Local cHelp		:= OemToAnsi("Relatório Inventário SD3 - GESTOR")
	Local cPerg 	:= padr("ESTR019",10)
	Local oRel		:= Nil
	Local oSection1	:= Nil
	Private rs 		:= 0  
...
Static Function ReportPrint(oRel)
	...
	If mv_par09 == 1
		...
		BeginSql  Alias cAliasTemp
			...
			AND D3_COD BETWEEN %Exp:mv_par05% AND %Exp:mv_par06%
		...
		//Memowrite("c:\temp\_ESTR019S.txt",_cResQry)
		oSection1:EndQuery()
	...
	Else
		...
		_cResQry:= GETLastQuery()[2]
		//Memowrite("c:\temp\_ESTR019A.txt",_cResQry)
...
Static Function CriaSX1(cPerg)
	...
	cDef04   := ""
	cDef05   := ""
	U_XPutSX1(cPerg, "01", "Emissao De?"		,"MV_PAR01", "MV_CH1", "D", 08,	0, "G", cValid,     cF3,   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe a Data inicial")
	U_XPutSX1(cPerg, "02", "Emissao Até?"  		,"MV_PAR02", "MV_CH2", "D", 08, 0, "G", cValid,     cF3,   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe a Data final")
	U_XPutSX1(cPerg, "03", "Grupo De?"	   		,"MV_PAR03", "MV_CH3", "C", 04,	0, "G", cValid,     "SBM",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Grupo inicial")
	U_XPutSX1(cPerg, "04", "Grupo Até?"	   		,"MV_PAR04", "MV_CH4", "C", 04, 0, "G", cValid,     "SBM",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Grupo final")
	U_XPutSX1(cPerg, "05", "Produto De?"		,"MV_PAR05", "MV_CH5", "C", 15,	0, "G", cValid,     "SB1",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Produto inicial")
	U_XPutSX1(cPerg, "06", "Produto Até?"		,"MV_PAR06", "MV_CH6", "C", 15, 0, "G", cValid,     "SB1",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Produto final")
	U_XPutSX1(cPerg, "07", "Armazem De?"		,"MV_PAR07", "MV_CH7", "C", 02,	0, "G", cValid,     "NNR",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Armazem inicial")
	U_XPutSX1(cPerg, "08", "Armazem Até?"		,"MV_PAR08", "MV_CH8", "C", 02, 0, "G", cValid,     "NNR",   cPicture,        cDef01,  cDef02,        cDef03,        cDef04,    cDef05, "Informe o Armazem final")
	U_XPutSX1(cPerg, "09", "Rel.Sintetico?"		,"MV_PAR09", "MV_CH9", "N", 01,  0, "C", cValid,      cF3,   cPicture,         "Sim",   "Não",         cDef03,       cDef04,    cDef05, "Informe Sim / Não para Data")
